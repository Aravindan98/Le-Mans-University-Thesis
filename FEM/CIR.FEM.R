...
bf<-function(x,theta){return(theta[3]^2*x)}

bfprime<-function(x,theta){return(theta[3]^2)}

CIR.FEM<-function(x0,theta,DeltaTime,param=list(Minf=0.3,Msup=0.6,N=200),R=10){
